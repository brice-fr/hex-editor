...
<style>
  ...
  @media (prefers-color-scheme: light) {
    .card          { background: #f8f8f8; border-color: #ddd; box-shadow: 0 24px 64px rgba(0,0,0,0.2); }
    .app-name      { color: #1e1e1e; }
    .divider       { border-top-color: #e0e0e0; }
    .app-copyright { color: #999; }
  }
</style>
